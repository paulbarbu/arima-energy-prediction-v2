...
* Maybe it would be helpful to generate the (standardised) Residuals vs fitted plot, although it wouldn't be of much help since the residuals are plotted against time and their patters are extracted and accounted for using the ACF & PACF plots
