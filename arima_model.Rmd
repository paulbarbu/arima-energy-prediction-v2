...
TODO: Plot the data transformed by the user if params$transformation is not identity()
TODO: continue with data$train.transformed here

TODO: say whether the following steps are applied on the transformed data or not (params$transformation != identity)
...
**`r nsdiffs(data$train)`**.

TODO: apply the diffops on the transformed data, set new transformed data, plot
TODO: apply the seasonaldiffops on the transformed data, plot
...
(representing **`r frequency(data$train) * params$traindays`** data points)
