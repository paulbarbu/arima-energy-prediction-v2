...
computed, the point forecast plus/minus the standard deviation multiplied by the 95% or 80% critical value of the two tailed Z distribution, this usually means the point forecast plus/minus twice the standard error. 
([ref. page 10](https://people.duke.edu/~rnau/Notes_on_linear_regression_analysis--Robert_Nau.pdf)).

The negative part should be limited at zero during the interpretation of the
results, but it is not on the plot due to simmetry and graphical reasons.
...
* Allow the number of Fourier terms (K) to be a vector and choose the best one automatically
